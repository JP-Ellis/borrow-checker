...
mod tests {
    ...
    fn imports_transaction_payee_and_narration() {
        ...
        assert_eq!(tx.payee.as_deref(), Some("SmartBear"));
        ...
        assert_eq!(tx.postings[1].account, "Income:Salary:SmartBear");
        assert_eq!(tx.postings[1].amount, Some(Amount::new(-895_233, "AUD", 2)));
    }
