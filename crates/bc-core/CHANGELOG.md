...
## [0.1.0](https://github.com/JP-Ellis/borrow-checker/releases/tag/bc-core/v0.1.0) - _2026-09-26_

### 🚀 Features
-   _(bc-cli)_ [**breaking**] Scope transaction edit flags
-   _(bc-core)_ Merge unequal legs with a warning
-   _(bc-ui)_ Accounts page opens on all time
-   _(bc-core)_ Paginated register with balances
-   _(bc-core)_ Earliest activity date for a scope
-   _(bc-core)_ Per-transaction scope ledger
-   _(bc-core)_ Add for_accounts residuals loader
-   _(bc-core)_ Set-based filtered stats, activity
-   _(bc-core)_ Stats and buckets over account sets
-   _(bc-core)_ Per-commodity subtree roll-up
-   _(bc-core)_ Expose inclusive subtree ids
-   _(bc-core)_ Render the annotation audit message
-   _(bc-core)_ Record posting annotation changes
-   _(bc-core)_ Map price and cost to the IPC posting
-   _(bc-ipc)_ Expose unvalued budget amounts
-   _(bc-core)_ Report unvalued budget actuals
-   _(bc-core)_ Plan one actuals load per reign
-   _(bc-core)_ Load residuals for an account subtree
-   _(bc-core)_ Name the batch a stopped run leaves open
-   _(bc-core)_ Add ImportEngine::sync
-   _(bc-core)_ Add ImportEngine::run_profile
-   _(bc-core)_ Expose a plan's blockers
-   _(bc-core)_ Carry price and cost through import
-   _(bc-core)_ Weigh priced legs in the residual
-   _(bc-core)_ Persist a posting's price and cost
-   _(bc-models)_ Keep a cost basis as stated
-   _(bc-core)_ Accept Period::Daily
-   _(bc-core)_ Reverse the tags a discarded import created
-   _(bc-core)_ Refuse a discard that orphans later legs
-   _(bc-core)_ Record the tags an import run mints
...
### 🐛 Bug Fixes
-   _(bc-core)_ Record the whole leg on PostingAdded
-   _(bc-core)_ Log posting tag changes
-   _(bc-core)_ Refuse unmerge after the leg changes
-   _(bc-core)_ Read scope_ledger on one snapshot
-   _(bc-core)_ Exact register_page membership
-   _(bc-core)_ Stable roll-up order and cycle guard
-   _(bc-core)_ Fold roll-up past archived ancestors
-   _(bc-core)_ Flag unvalued at every tree node
-   _(bc-core)_ Order unvalued groups by code
-   _(bc-core)_ Match amount filters on elided legs
-   _(bc-core)_ Resolve elided legs in budget drill-down
-   _(bc-core)_ Count elided legs in budget actuals
-   _(bc-cli)_ Keep engine exit codes in import run
-   _(bc-core)_ Snapshot before the first write
-   _(bc-core)_ Key the own-commodity warning by code
-   _(bc-core)_ Weigh legs in the document residual
-   _(bc-core)_ Carry a posting's price through edit
-   _(bc-core)_ Report what net_worth cannot value
-   _(bc-core)_ Skip the event on a no-op set_opened_on
-   _(bc-core)_ Reject a child under a closed parent
-   _(bc-core)_ Thread opened_on through create_paths
-   _(bc-core)_ Log opened_on in the event stream
...
### 🚜 Refactor
-   _(bc-core)_ [**breaking**] Drop TransactionService::amend
-   _(bc-core)_ Hoist TagPath into the test imports
-   _(bc-core)_ Edit states price and cost
-   _(bc-core)_ Date fetched posting amounts
-   _(bc-core)_ Resolve account filter before snapshot
...
### ⚡ Performance
-   _(bc-core)_ Fold rollover forward in one pass
...
### 📚 Documentation
-   _(bc-core)_ Drop amend from event docs
-   _(bc-core)_ List annotation in edit's events
-   _(bc-core)_ Update merge warning and error docs
-   _(bc-core)_ Correct register_page comments
-   _(bc-core)_ Say why a negative quote is rejected
-   _(bc-core)_ Say unvalued spans the carry chain
...
### 🧪 Testing
-   _(bc-core)_ Cover the posting tags audit entry
-   _(bc-core)_ Cover latest_activity_date_for_set
-   _(bc-core)_ Cover a roll-up register scope
-   _(bc-core)_ Cover multi-account filtered stats
-   _(bc-core)_ Per-account residual coverage
-   _(bc-core)_ Cover a chain across tag-filtered reigns
-   _(bc-core)_ Cover more elided budget scenarios
-   _(bc-core)_ Pin expand_posting_rows error arms
-   _(bc-core)_ Cover elided legs across budget filters
-   _(bc-core)_ Load a costed sibling's residual
-   _(bc-core)_ Pin daily rollover across days
-   _(bc-core)_ Close the gaps review found in net_worth
-   _(bc-core)_ Assert DiscardBlocked's message
-   _(bc-core)_ Import, discard, import leaves tags flat
