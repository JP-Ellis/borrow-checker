...
## [0.1.0](https://github.com/JP-Ellis/borrow-checker/releases/tag/bc-models/v0.1.0) - _2026-09-18_

### 🚀 Features
-   _(bc-models)_ Serialise Balances as a map
-   _(bc-models)_ Add carry_chain_start
-   _(bc-models)_ Price a posting and weigh it
-   _(bc-models)_ Keep a cost basis as stated
-   _(bc-models)_ Add Quote for a stated figure
-   _(bc-models)_ Add Period::Daily
-   _(bc-models)_ Add account open and close dates
-   _(bc-models)_ Compare metadata ignoring mismatch
-   _(bc-models)_ Add canonical MetaValue string form
-   _(bc-models)_ Add MetaKeyDef registry record
-   _(bc-models)_ Add MetaEntry and Metadata
-   _(bc-models)_ Add MetaValue and MetaType
-   _(bc-models)_ Add validated MetaKey newtype
...
### 🐛 Bug Fixes
-   _(bc-models)_ Weigh a total quote by magnitude
-   _(bc-core)_ Weigh legs in the document residual
-   _(bc-models)_ Split amount on the first space
-   _(bc-models)_ Encode metadata invariants
...
### 🚜 Refactor
-   _(bc-models)_ Metadata replaces payee/note
...
### 📚 Documentation
-   Describe balancing by weight, warned not enforced
-   Correct two overstated account claims
-   _(bc-models)_ Mismatched is derived on write
