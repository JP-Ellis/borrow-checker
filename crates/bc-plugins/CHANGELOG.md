...
## [0.1.0](https://github.com/JP-Ellis/borrow-checker/releases/tag/bc-plugins/v0.1.0) - _2026-09-26_

### 🚀 Features
-   _(beancount)_ Pass price and cost to the host
-   _(bc-sdk)_ Carry price and cost across the WIT
...
### 🐛 Bug Fixes
-   _(beancount)_ Parse Beancount's number grammar
...
### 📚 Documentation
-   _(bc-plugins)_ Name BadValue in wit_posting's errors
